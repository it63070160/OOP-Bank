...
public class menu extends javax.swing.JPanel {
    ...
    private void init() {
        listMenu1.addItem(new Model_Menu("1", "Overview", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("2", "Account", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("3", "Deposit", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("4", "Withdrawn", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("5", "Transfer", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("6", "Transaction", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("", " ", Model_Menu.MenuType.EMPTY));
        
        listMenu1.addItem(new Model_Menu("", "Others", Model_Menu.MenuType.TITLE));
        listMenu1.addItem(new Model_Menu("", " ", Model_Menu.MenuType.EMPTY));
        listMenu1.addItem(new Model_Menu("7", "About", Model_Menu.MenuType.MENU));
